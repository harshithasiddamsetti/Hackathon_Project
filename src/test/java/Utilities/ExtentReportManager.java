...
public class ExtentReportManager  implements ITestListener {
	...
	public ExtentReports extent; //providing common info to the report
	public ExtentTest test; //creating actual tests in report
	WebDriver driver;
	...
	public void onStart(ITestContext testContext ) {
		...
		extent.setSystemInfo("Tester Name","Harshitha Siddamsetti");
